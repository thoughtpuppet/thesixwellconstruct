  ...
  try {
    for (const [index, item] of files.entries()) {
      ...
      await db.prepare(`INSERT INTO media_assets
        (id,storage_key,original_filename,mime_type,byte_size,alt_text,rights_notes,privacy,consent_status,state,created_by,created_at,updated_at,public_presentation)
        VALUES (?,?,?,?,?,?,?,'internal','granted','active','calendar-public-submission',?,?, 'hidden')`)
