...
export const RESOURCE_CONFIG = {
  ...
  "tattoo-designs": { table: "tattoo_designs", entityType: "tattoo_design", states: ["draft","published","retired","archived"], fields: ["slug","title","description","design_type","state","sort_order"] },
  ...
  "visual-language": { table: "visual_symbols", entityType: "visual_symbol", states: ["draft","published","retired","archived"], fields: ["category_id","slug","name","meaning","svg_markup","themes_json","context_json","applications_json","variants_json","examples_json","build_guidance_json","state","sort_order"] },
  art: { table: "art_works", entityType: "art_work", states: ["draft","published","retired","archived"], fields: ["series_id","slug","title","statement","year","medium","dimensions","availability","whereabouts_status","acquisition_eligible","print_intent","state","legacy_path","sort_order"] },
  merch: { table: "merch_items", entityType: "merch_item", states: ["draft","published","retired","archived"], fields: ["slug","shopify_handle","title","product_type","state","availability_state","route","source_venture","catalog_number","statement","description","edition_text","shipping_note","price_note","image_url","alt_text","origin_title","origin_path","origin_thumb","origin_meta","options_json","notify_enabled","sort_order"] },
  archive: { table: "archive_records", entityType: "archive_record", states: ["draft","published","retired","archived"], fields: ["title","slug","node_label","record_type","room","date_or_period","timeline_period","summary","body","body_html","record_status","state","why_it_matters","source_note","practice_sections_json","related_notes_json","related_routes_json","sort_order"] },
  appearances: { table: "artist_appearances", entityType: "appearance", states: ["draft","published","retired","archived"], fields: ["slug","title","summary","description","starts_at","ends_at","timezone","lifecycle_status","formats_json","participation_roles_json","ticket_url","source_url","state","sort_order"] },
  "current-projects": { table: "about_current_projects", entityType: "current_project", states: ["draft","published","retired","archived"], fields: ["slug","category","title","context_line","summary","items_json","status_label","medium_key","links_json","state","collage_slot","focal_x","focal_y","sort_order"] },
  ...
  organizations: { table: "organizations", entityType: "organization", states: ["draft","published","retired","archived"], fields: ["name","slug","organization_type","description","website_url","social_url","state"] },
