...
export const RESOURCE_CONFIG = {
  ...
  merch: { table: "merch_items", entityType: "merch_item", states: ["draft","published","retired","archived"], fields: ["shopify_handle","title","product_type","state","route","image_url","alt_text","sort_order"] },
