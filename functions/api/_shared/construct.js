...
export const RESOURCE_CONFIG = {
  ...
  "visual-language": { table: "visual_symbols", entityType: "visual_symbol", states: ["draft","published","retired","archived"], fields: ["category_id","slug","name","meaning","svg_markup","themes_json","context_json","applications_json","variants_json","examples_json","state","sort_order"] },
