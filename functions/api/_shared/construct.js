...
export const RESOURCE_CONFIG = {
  flash: { table: "flash_items", entityType: "flash_item", states: ["draft","available","reserved","placed","retired","archived"], fields: ["series_id","slug","title","description","state","size_bucket","price_label","item_type","claimable","sheet_code","design_code","legacy_path","merch_status","merch_url","related_nodes_json","sort_order"] },
