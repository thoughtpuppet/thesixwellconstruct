...
export const RESOURCE_CONFIG = {
  ...
  "current-projects": { table: "about_current_projects", entityType: "current_project", states: ["draft","published","retired","archived"], fields: ["slug","category","title","context_line","summary","status_label","medium_key","links_json","state","collage_slot","focal_x","focal_y","sort_order"] },
