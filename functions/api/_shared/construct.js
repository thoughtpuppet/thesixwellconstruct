...
export const RESOURCE_CONFIG = {
  ...
  art: { table: "art_works", entityType: "art_work", states: ["draft","published","retired","archived"], fields: ["series_id","slug","title","statement","year","medium","dimensions","availability","acquisition_eligible","print_intent","state","legacy_path","sort_order"] },
