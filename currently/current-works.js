(function () {
  ...
  const fallbackProjects = [
    ...
    { id:"current-project-solehman-letters",slug:"solehman-letters",category:"Writing + Publishing",title:"The Solehman Letters + Mindful Darkness",contextLine:"Ongoing · Newsletter + writing platform",summary:"Two connected publishing spaces for letters, essays, studio notes, reflections, and discussion moving through the Construct.",items:[{title:"The Solehman Letters",description:"A direct publishing channel for letters, essays, studio notes, and reflections moving through the Construct."},{title:"Mindful Darkness",description:"A developing space for essays, reflections, and discussion around what emerges through the practice."}],status:"Ongoing",accent:"writings",links:[{label:"Read The Solehman Letters",url:"https://www.solehmanletters.com/"},{label:"Mindful Darkness",url:"/writings/mindful-darkness/"}] },
    { id:"current-project-events",slug:"solehmans-new-year-greenfield",category:"Events",title:"Solehman’s New Year + GREEN[FIELD]",contextLine:"Forthcoming",summary:"Solehman’s New Year is one four-day annual presentation of the ecosystem, anchored by the annual exhibition and extending through fashion, tattooing, conversation, tools, objects, and open-studio viewing. GREEN[FIELD] holds community shows, performances, and shared experiments.",items:[{title:"Solehman’s New Year",description:"A four-day annual presentation of the ecosystem, anchored by the annual exhibition and extending through fashion, tattooing, conversation, tools, objects, and open-studio viewing."},{title:"GREEN[FIELD]",description:"Holds community shows, performances, and shared experiments."}],status:"Forthcoming",accent:"events",links:[{label:"Solehman’s New Year",url:"/events/solehmans-new-year/"},{label:"GREEN[FIELD]",url:"/events/greenfield/"}] }
  ];
