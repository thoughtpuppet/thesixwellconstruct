(function () {
  ...
  var PUBLIC_TEMPLATES = [
    ...
    { id: "construct-explore", label: "Explore / random discovery", kind: "interactive", accent: "about", route: "/explore/", sources: ["explore/index.html", "css/explore.css", "js/explore.js", "functions/api/construct/_lib.js", "js/construct-nav.js"], adoption: "Public interactive template adopted · separate from the nine medium nodes", description: "Balanced cross-Construct discovery across works and objects, process and evidence, and public pages and pathways, with immediate navigation, history exclusions, and retryable feedback." },
