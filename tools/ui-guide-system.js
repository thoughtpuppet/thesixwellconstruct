(function () {
  ...
  var PUBLIC_TEMPLATES = [
    ...
    { id: "merch-product", label: "Merch product detail", kind: "commerce-detail", accent: "merch", route: "/merch/lostmarbles-hoodie/", sources: ["merch/detail/index.html", "css/merch-detail.css"], description: "Shared Studio-backed product detail, availability, launch alerts, commerce controls, and origin record." },
