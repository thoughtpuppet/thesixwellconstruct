(function () {
  ...
  var PUBLIC_TEMPLATES = [
    ...
    { id: "archive-place-dossier", label: "Archive place dossier", kind: "editorial-dossier", accent: "archive", route: "/archive/places/jr-erikson-building/", routes: ["/archive/places/", "/archive/places/jr-erikson-building/", "/archive/places/goat-farm-arts-center/"], sources: ["archive/places/index.html", "archive/places/jr-erikson-building/index.html", "archive/places/goat-farm-arts-center/index.html", "css/archive-place-study.css"], description: "Source-led place lens with stable public routes, verified and inferred claim labels, documentary evidence, chronology, open questions, and linked source registers; places remain contextual rather than cultural-object records." },
