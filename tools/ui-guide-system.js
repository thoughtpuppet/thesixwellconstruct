(function () {
  ...
  var PUBLIC_TEMPLATES = [
    ...
    { id: "archive-explorer", label: "Archive explorer", kind: "search", accent: "archive", route: "/archive/", sources: ["archive/index.html", "js/archive-public.js"], description: "Managed archive search, filters, result states, collection entry, and public record navigation." },
    ...
    { id: "archive-record", label: "Archive record / dossier", kind: "archive-record", accent: "archive", route: "/archive/records/:slug/", sources: ["archive/records/index.html", "js/archive-public.js"], description: "Dynamic dossier with identity, materials, activities, relationships, visibility, and timeline context." },
    ...
    { id: "legend-catalog", label: "Legend taxonomy", kind: "taxonomy", accent: "about", route: "/about/legend/", sources: ["about/legend/index.html", "js/legend-catalog.js"], description: "Symbol filters, search, catalog cards, detail region, meaning, applications, and system usage." },
  ...
  var STUDIO_PATTERNS = [
    ...
    { id: "studio-dossier", label: "Construct dossier", kind: "studio-dossier", route: "/studio/submissions/#archive/dossiers", sources: ["studio/construct-manager.js", "studio/construct-manager.css"], description: "Dossier workspace, materials, history, visibility, connections, publication gate, and sticky section navigation." },
  ...
  function studioMarkup(record) {
    ...
    if (record.kind === "studio-editor" || record.kind === "studio-dossier") {
