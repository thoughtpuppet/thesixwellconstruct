...
VALUES
  ('cal_source_cabbagetown','Cabbagetown Initiative','https://cabbagetown.com/wow','official_html','official',1,24,'automatic','static','{}',datetime('now'),datetime('now')),
...
VALUES
  ('cal_candidate_words_on_wylie','cal_source_cabbagetown','words-on-wylie-2026',
  ...
  ('cal_candidate_goat_grrl','cal_source_goat_farm','cut-corners-presents-grrl',
  ...
  ('cal_candidate_goat_leaflet_riso','cal_source_goat_farm','leaflet-women-in-riso',
  ...
  ('cal_candidate_goat_site_2026','cal_source_goat_farm','site-2026',
  ...
  ('cal_candidate_goat_pleiades','cal_source_goat_farm','chamber-cartel-pleiades',
  ...
  ('cal_candidate_measure_without','cal_source_sandler_hudson','a-measure-without-2026',
...
VALUES
  ('cal_candidate_words_on_wylie','Poetry responding to murals, accessibility, and public art form a distinctive cross-medium model.','Attend and network.','Study ekphrasis, accessible descriptions, archives, and public-space pacing.','Cabbagetown Initiative; Forward Warrior; participating muralists and poets.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_goat_grrl','Experimental electronic music, visual installation, movement, and spatial design converge in one environment.','Attend and network.','Study Cut Corners’ integration of stage design, installation, sound, and audience movement.','Cut Corners; Goat Farm; participating installation artists.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_goat_leaflet_riso','Community print culture and a live material demonstration connect publishing, visual art, and artist education.','Attend and network.','Study the artist-talk, panel, and live-demonstration sequence.','Posy Press; Goat Farm; participating RISO artists.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_goat_site_2026','Campus-wide site-responsive commissions across art, film, performance, music, and installation strongly match Six.Well’s creative-systems research.','Attend and network.','Study concurrent activation of a twelve-acre campus and movement between disciplines.','Goat Farm; SITE artists; Living Walls; L42i; Sound Service.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_goat_pleiades','Large-scale percussion, microtonal instruments, and sensory intensity offer a strong experimental performance reference.','Attend for research.','Study spatial sound, unusual instrumentation, duration, and audience focus.','Chamber Cartel; Caleb Herron; Goat Farm.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_measure_without','Negative space, architecture, temporary walls, and perceptual restructuring directly connect to current visual and built-environment interests.','Attend opening and network.','Study how temporary architecture changes the reading of individual works.','Sandler Hudson Gallery; Whitespace Gallery; featured artists.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_eyedrum_bryan_day','Invented instruments, everyday materials, sound sculpture, interaction, perception, and communication make this an exceptionally close match.','Attend and network.','Study object-to-sound translation and structured improvisation.','Bryan Day; Erin Demastes; Dylan Burchett; Klimchak; Alexandria Smith; Eyedrum.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_eyedrum_wheelchair_sports','Queer and disability-led performance, accessibility, hip-hop, punk, installation, theater, and film create a strong community-centered model.','Attend and network.','Study accessibility as a core programming structure rather than an accommodation layer.','Wheelchair Sports Camp; Gaelynn Lea; Eyedrum.','Private Scout intelligence; never return from public APIs.',datetime('now')),
  ('cal_candidate_eyedrum_akchamel','Masked ritual, droning psychedelic folk, and theatrical atmosphere strongly align with neo-surreal and ceremonial presentation.','Attend for inspiration.','Study how costume, anonymity, duration, and atmosphere transform a concert into a constructed encounter.','AK’chamel; Franks; Eyedrum.','Private Scout intelligence; never return from public APIs.',datetime('now'));
...
SET status='needs_verification',verification_state='needs_verification',monitoring_enabled=1,
    next_check_at=datetime('now'),updated_at=datetime('now')
