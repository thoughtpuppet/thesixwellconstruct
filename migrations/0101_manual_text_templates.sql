...
INSERT OR IGNORE INTO manual_text_templates (template_key, body_text, updated_by, updated_at) VALUES
  ...
  ('closing_tattoo', 'Thank you for trusting me with your tattoo. If any questions come up, feel free to reach out.', 'migration', datetime('now')),
  ...
  ('tattoo_inquiry_received', 'We received your inquiry and will review the project details before sending booking access.', 'migration', datetime('now'));
