...
const tattooIndex = read("tattoos/index.html");
...
assert.match(editor, /hasAttribute\('data-live-edit-container'\)/);
...
assert.doesNotMatch(tattooIndex, /id="tattooRateList"[^>]+data-live-edit-owner="managed"/);
assert.doesNotMatch(tattooIndex, /id="tattooSessionList"[^>]+data-live-edit-owner="managed"/);
assert.match(tattooIndex, /data-copy-id="tattoos-rate-flash-body"/);
assert.match(tattooIndex, /data-copy-id="tattoos-session-quarter-description"/);
assert.match(tattooIndex, /data-copy-id="tattoos-session-extended-policy"/);
assert.match(tattooIndex, /data-booking-type="tattoo_quarter" data-live-edit-container/);
assert.match(tattooIndex, /class="rate-figure" data-live-edit-owner="managed"[^>]+#tattoo\/tattoo-settings/);
assert.match(tattooIndex, /class="session-deposit-value" data-live-edit-owner="managed"[^>]+#tattoo\/availability/);
assert.doesNotMatch(tattooIndex, /rateList\.replaceChildren\(\)/);
assert.doesNotMatch(tattooIndex, /description\.textContent\s*=\s*type\.description/);
