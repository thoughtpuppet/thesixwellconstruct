(function (global) {
  ...
  function start() {
    ...
    function ensureConnections() {
      ...
      return new Promise((resolve) => { const script=document.createElement("script"); script.src="/js/construct-connections.js?v=10"; script.onload=resolve; script.onerror=resolve; document.head.append(script); });
    }
