(function(){
  ...
  window.ConstructManager={isManagedView:(tab,view)=>managed[tab]?.has(view)||false,render:(tab,view)=>tab==="merch"&&view==="products"?import("/studio/merch-manager.js?v=20260811-multi-image-staging").then(module=>module.mount(root(),api,status)):tab==="about"&&view==="appearances"?renderResource("appearances"):tab==="archive"&&view==="organizations"?renderResource("organizations"):render(tab,view)};
})();
