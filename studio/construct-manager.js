(function(){
  ...
  window.ConstructManager={isManagedView:(tab,view)=>managed[tab]?.has(view)||false,render:(tab,view)=>tab==="merch"&&view==="products"?import("/studio/merch-manager.js?v=20260806-product-media").then(module=>module.mount(root(),api,status)):render(tab,view)};
})();
