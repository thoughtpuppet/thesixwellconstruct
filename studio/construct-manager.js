(function(){
  ...
  window.ConstructManager={isManagedView:(tab,view)=>managed[tab]?.has(view)||false,render:(tab,view)=>tab==="merch"&&view==="products"?import("/studio/merch-manager.js").then(module=>module.mount(root(),api,status)):render(tab,view)};
})();
