(function(){
  ...
  const archiveWorkspace={dossiers:[],media:[],originThreads:[],catalogueMedia:[],objectTypes:[],documentationFields:[],documentation:[],entities:[],selectedEntityId:"",detail:null,materials:[],activities:[],versions:[],states:[],filter:"",previewUrls:[]};
