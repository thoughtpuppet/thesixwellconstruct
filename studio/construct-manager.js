    ...
    if(String(options.method||"GET").toUpperCase()==="POST"){
      try{
        ...
        if(handoff?.id&&expected&&path===expected&&entityId){
          ...
          await import("/studio/media-catalogue-manager.js?v=20260904-gallery-intake-ephemera").then(module=>module.completeSourceMediaHandoff(api,entityId,{relationship_type_id:relationship,role:handoff.type==="note"?"source":"documentation",public_visible:false}));
